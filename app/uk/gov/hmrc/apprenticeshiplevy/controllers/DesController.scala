  ...
  protected val desErrorHandler: PartialFunction[Throwable, Result] = {
    ...
    case e: UpstreamErrorResponse =>
      ...
      e.statusCode match {
        ...
        case FORBIDDEN =>
          Forbidden(Json.toJson[ErrorResponse](DESError(e.reportAs, "FORBIDDEN", s"DES forbidden error")))
        case UNAUTHORIZED =>
          Unauthorized(Json.toJson[ErrorResponse](DESError(e.reportAs, "UNAUTHORIZED", s"DES unauthorised error")))
